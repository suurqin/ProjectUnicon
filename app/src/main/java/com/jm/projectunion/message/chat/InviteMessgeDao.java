...
public class InviteMessgeDao {
	...
	public Integer saveMessage(InviteMessage message){
		return EaseImDBManager.getInstance().saveMessage(message);
	}
	...
	public void updateMessage(int msgId,ContentValues values){
		EaseImDBManager.getInstance().updateMessage(msgId, values);
	}
	...
	public List<InviteMessage> getMessagesList(){
		return EaseImDBManager.getInstance().getMessagesList();
	}
	
	public void deleteMessage(String from){
		EaseImDBManager.getInstance().deleteMessage(from);
	}

	public void deleteGroupMessage(String groupId) {
		EaseImDBManager.getInstance().deleteGroupMessage(groupId);
	}

	public void deleteGroupMessage(String groupId, String from) {
		EaseImDBManager.getInstance().deleteGroupMessage(groupId, from);
	}
	
	public int getUnreadMessagesCount(){
	    return EaseImDBManager.getInstance().getUnreadNotifyCount();
	}
	
	public void saveUnreadMessageCount(int count){
		EaseImDBManager.getInstance().setUnreadNotifyCount(count);
	}
}
