...
public class EaseImDBManager {
    static private EaseImDBManager dbMgr = new EaseImDBManager();
    private DbOpenHelper dbHelper;

    private EaseImDBManager(){
        dbHelper = DbOpenHelper.getInstance(MyApplication.getInstance().getApplicationContext());
    }

    public static synchronized EaseImDBManager getInstance(){
        if(dbMgr == null){
            dbMgr = new EaseImDBManager();
        }
        return dbMgr;
    }
