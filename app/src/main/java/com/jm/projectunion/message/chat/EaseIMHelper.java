...
import com.jm.projectunion.message.chat.EaseIMModel;
import com.jm.projectunion.message.chat.InviteMessage.InviteMessageStatus;
import com.jm.projectunion.message.chat.RobotUser;
import com.jm.projectunion.message.chat.helper.CallReceiver;
import com.jm.projectunion.message.chat.helper.Constant;
import com.jm.projectunion.message.chat.helper.parse.UserProfileManager;
...
public class EaseIMHelper {
    ...
    private static EaseIMHelper instance = null;

    private EaseIMModel demoModel = null;
    ...
    public synchronized static EaseIMHelper getInstance() {
        if (instance == null) {
            instance = new EaseIMHelper();
        }
        return instance;
    }
...
//            EMClient.getInstance().addMultiDeviceListener(new MyMultiDeviceListener());
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            Map<String, EaseUser> localUsers = EaseIMHelper.getInstance().getContactList();
...
//                break;
    ...
    protected void onUserException(String exception) {
        ...
        showToast(exception);
        EventBus.getDefault().post(new IMLoginOutEvent());
...
//                        }
    ...
    public EaseIMModel getModel() {
        return (EaseIMModel) demoModel;
    }
    ...
    synchronized void reset() {
        ...
        EaseImDBManager.getInstance().closeDB();
    }
