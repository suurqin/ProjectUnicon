...
public class FriendRect implements Serializable {
    /**
    ...
    private List<FriendBean> recList;
    ...
    public List<FriendBean> getRecList() {
        return recList;
    }

    public void setRecList(List<FriendBean> recList) {
