...
public class DataCleanManager {
    ...
    /**
     * 获取本应用内部data根目录(/data/data/com.xxx.xxx/)
     *
     * @param context 上下文
     */
    ...
    public static void cleanDatabases(Context context) {
        deleteFilesByDirectory(new File(getDatabasesDir(context)));
    }
    ...
    public static void cleanSharedPreference(Context context) {
        deleteFilesByDirectory(new File(getSharedPreferenceDir(context)));
    }

    public static String getSharedPreferenceDir(Context context) {
        return context.getFilesDir().getPath() + context.getPackageName() + "/shared_prefs";
    }
