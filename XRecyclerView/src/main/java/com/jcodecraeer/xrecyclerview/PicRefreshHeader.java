...
public class PicRefreshHeader extends BaseRefreshHeader {
    private LinearLayout mContainer;
    private ImageView pic_refresh;
    ...
    private void initView(Context context) {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(context).inflate(
                R.layout.listview_header_pic, null);
        ...
        pic_refresh = (ImageView) findViewById(R.id.refresh_pic);
    ...
    public void setState(int state) {
        ...
        switch (state) {
            ...
            case STATE_REFRESHING:
                ...
                mStatusTextView.setText("爱学邦正在为您更新");
                break;
            case STATE_DONE:
                handler.removeCallbacks(runnable);
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Drawable drawable = pic_refresh.getDrawable();
